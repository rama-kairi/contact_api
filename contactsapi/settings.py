...
SECRET_KEY = '*l3xz8n+nt-%mfa1bv-!80b^2307)5&!_wi09$!rx9bskf5c#v'
...
CORS_ORIGIN_WHITELIST = [
    "http://localhost:3000",
    "https://contactapi.digitalrama.co.in",
    "https://contactapp.digitalrama.co.in",
    "http://127.0.0.1:8080"
]

CORS_ORIGIN_REGEX_WHITELIST = [
    r"^https://\w+\.digitalrama\.co.in$",
]
...
## All the Necessary Changes Done
